...
if(isset($_GET['import']) && $_GET['import'] == "OK") {
    ...
    $data2 = array();
    $arrayUsers = array(
        array("hoadam@vus-etsc.edu.vn", "Đàm Phạm Minh Hòa", "+84989232402", "60d98c136f9c907706c41b0d", "verified", "123456@"),
        array("linh.npm@vus-etsc.edu.vn", "Nguyễn Phạm Mỹ Linh", "+84975296903", "60d98c136f9c907706c41b0d", "verified", "123456@"),
        array("thuphamt@vus-etsc.edu.vn", "Phạm Thị Thư", "+84905576986", "60d98c136f9c907706c41b0d", "verified", "123456@"),
    );
