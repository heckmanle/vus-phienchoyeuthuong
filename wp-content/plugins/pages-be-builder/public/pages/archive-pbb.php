...
add_filter('pre_get_document_title', function ($title){
	$title .= ' ' . __('Pages be builder', PAGES_BE_BUILDER_LANG_DOMAIN);
	return $title;
}, 100);
...
<script>
    const PBB_IMAGE_LOADING = {
        message: '<div class="ball-clip-rotate-multiple"> <div></div><div></div></div>',
    };
    const PBB_THOUNSAND_SEP = ',';
    const PBB_DECIMAL_SEP = '.';
    const PBB_NUM_DECIMAL = 0;
    const PBB_AJAX_URL = "<?php echo PAGES_BE_BUILDER_AJAX_URL; ?>";
</script>
<div class="ppb-layout-product-create w-100">
	<div class="container-fluid">
        <div class="row">
            <div class="col-md-3">

                <div class="d-md-flex justify-content-md-between align-items-center">
                    <h3 class="mb-3 pb-0 d-flex align-items-center"><img width="20" class="mr-2 icon-my-pbb" src="<?php echo PAGES_BE_BUILDER_PUBLIC_URL . 'images/icons/icon-my-rep.svg' ?>"><span><?php _e('Pages', PAGES_BE_BUILDER_LANG_DOMAIN) ?></span></h3>
                ...
                <div class="pbb-product-list">
                    <div class="position-relative" id="pbb-product-tabs-content">
                        <div class="" id="pbb-myposts" role="tabpanel" aria-labelledby="home-tab">
                            <div class="pbb-myposts-content" data-simplebar data-simplebar-auto-hide="false">
                                <ul class="" >

                                </ul>
                            </div>
                            <div class="pbb-section-pagination"></div>
                        </div>
                        <div class="tab-pane fade" id="pbb-myposts-favorite" role="tabpanel" aria-labelledby="profile-tab">... ....</div>
                    </div>
                </div>
            </div>
            <div class="col-md-9" id="pbb-pro-detail-content" data-simplebar data-simplebar-auto-hide="false">
                <form class="pbb-form-product position-relative" action="<?php echo PAGES_BE_BUILDER_AJAX_URL; ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="action" value="pbb_handle_ajax">
                    <input type="hidden" name="func" value="pbb_pages_handle">
                    <div style="padding-right: 15px;">
                        <div class="pbb-pro-detail">
                            <p class="alert_aligncenter">Please add new page or choose page for update ..</p>
                        </div>
                    </div>
                </form>
            </div>
...
<script id="tpl-product-detail" type="text/html">
    <div class="row">
        <div class="col-md-9">
            <label>Title</label>
            <div class="pbb-pro-title-content form-group d-flex align-items-center justify-content-between">
                <div class="form-group position-relative w-100 pr-3 overflow-hidden">
                    ...
                    <input type="text" class="form-control input-pro-title material-form-control px-0<# if(id){ #> d-none<# } #>" value="{{ product_title }}" id="product_title" name="product_title" data-is-validation="true" placeholder=".." required>
                    <span class="focus-border"></span>
                </div>
                <a href="javascript:;" class="js-edit-pro-title pbb-edit-pro-title">
            ...
            <div class="pbb-builder-layout pt-3<# if(!id){ #> d-none<# } #>">
                <h3 class="font-weight-bold">Editor</h3>
                <p>You can add more content by default layout or drag/drop below</p>
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{ edit_post_url }}" target="_blank" class="pbb-drag-drop-layout d-block">
            ...
            <div class="pbb-builder-layout<# if(!id){ #> d-none<# } #>">
                <hr/>
        ...
        <div class="col-md-3">
                ...
                <div class="postbox-container px-2">
                    <div class="row">
                        <div class="col-md-6 py-2">
                            <div class="d-flex align-items-center pbb-100">
                        ...
                        <div class="col-md-6 py-2">
                            <div class="row">
                                <div class="col-md-8 p-0">
                                    <div class="pbb-pro-action-save d-flex justify-content-end">
                                        <button class="btn btn-submit" id="pbb-btn-pro-action-save"><img src="<?php echo REAL_ESTATE_PRODUCTS_PUBLIC_URL ?>images/icons/icon-update.png" width="15" class="mr-1"> Update</button>
                                    </div>
                                </div>
                                <# if(id){ #>
                                <div class="col-md-4 p-0">
                                    <div class="pbb-pro-action-delete d-flex justify-content-end">
                                        <button class="btn btn-submit" id="pbb-btn-pro-action-delete" data-id="{{id}}">Delete</button>
                                    </div>
                                </div>
                                <# } #>
                            </div>
            ...
            <div id="productimagesdiv" class="postbox postbox-images">
                ...
                <div class="postbox-container">
                    <div class="inside">
                        <div class="pbb-pro-gallery mb-3 px-2">
                            <div class="row pbb-pgi-content">
                                <#
                                ...
                                #>
                                {{{ gli }}}
                                <div class="col-md-6 px-1 pbb-pgi pbb-pgi-add">
                                    <label class="pbb-pro-gallery-item pbb-js-pro-gallery-add">
...
<script id="tpl-gallery-item" type="text/html">
    <div class="col-md-6 px-1 pbb-pgi mb-2" data-idx="{{ idx }}">
        <div class="pbb-pro-gallery-item">
            <#
            let img_src = '';
            if( file ){
...
<script id="tpl-product-item" type="text/html">
    <li class="pbb-product-item" data-id="{{ id }}">
        <div class="d-flex">
            <div class="pbb-pro-left mr-3">
                <div class="pbb-pro-image">
                    <img src="{{ thumbnail }}">
                </div>
            </div>
            <div class="pbb-pro-right">
                <h5 class="pbb-pro-title">{{ product_title }}</h5>
                <div class="pbb-pro-property">
                    <span class="pbb-pro-status mr-3 pbb-pro-status-{{ product_status }}">
                    ...
                    <span class="pbb-pro-date">{{ livetimestamp }} | {{ updated }}</span>
                </div>
            </div>
        </div>
    </li>
...
<?php
wp_enqueue_style('pages-be-builder');
wp_enqueue_script('pages-be-builder');
wp_localize_script('pages-be-builder', 'PBB_GLOBAL', [
    'page' => $page,
    'limit_file' => Pages_Be_Builder_Public::LIMIT_FILE,
]);
get_footer();