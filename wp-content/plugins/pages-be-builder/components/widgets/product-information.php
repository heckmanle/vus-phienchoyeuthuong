...
class ProductInformation extends \WP_Widget
{
	...
	{
		$id_base = 'pbb-product-information';
		$name = __('PBB Information', REAL_ESTATE_PRODUCTS_LANG_DOMAIN);
		...
		if( is_user_logged_in() ) {
			...
			if( !empty($pro_id) ){
				...
				if( !is_wp_error($response) ){
					...
					<div class="row">
						<div class="col-md-7">
							<h3 class="ppb-wdpinfo-property-title">' . __('Property informations', REAL_ESTATE_PRODUCTS_LANG_DOMAIN) . '</h3>
							' . $product_description . '
						</div>
						<div class="col-md-5">
							<div class="d-md-flex justify-content-end">
								<div class="ppb-wdpinfo-author">
								<div class="ppb-wdpinfo-author-avatar mb-3">
									<a href="javascript:;" class="m-auto">
										<img src="' . $user_avatar . '" class="w-100">
									</a>
								</div>
								<div class="ppb-wdpinfo-author-name text-center">
									<div class="ppb-wdpinfo-author-full-name d-flex align-items-center justify-content-center">
	...
	<path fill-rule="evenodd" clip-rule="evenodd" d="M16.3107 7.04297C16.7012 7.43349 16.7012 8.06666 16.3107 8.45718L10.1036 14.9572C9.71307 15.3477 9.0799 15.3477 8.68938 14.9572L5.68938 11.9572C5.29885 11.5667 5.29885 10.9335 5.68938 10.543C6.0799 10.1524 6.71307 10.1524 7.10359 10.543L9.39648 12.8359L14.8965 7.04297C15.287 6.65244 15.9202 6.65244 16.3107 7.04297Z" fill="white"/>
									...
									<div class="ppb-wdpinfo-author-join pb-2">Agent • Joined 2020</div>
								</div>
								<div class="ppb-wdpinfo-author-contact d-flex align-items-center justify-content-center">
									<span class="pr-3 ppb-wdpinfo-author-contact-title">' . __('Contact Agent', REAL_ESTATE_PRODUCTS_LANG_DOMAIN) . '</span>
									<a href="javascript:;" class="ppb-wdpinfo-author-icon-message ppb-wdpinfo-author-group-icon-item">
